-- Final PRD hardening: cron secret seed helper and Day-14 incomplete recommendation.

create or replace function public.adrianoos_set_cron_secret(p_secret text)
returns jsonb
language plpgsql
security definer
...
grant execute on function public.adrianoos_set_cron_secret(text) to anon;
