-- Add cumulative review-card context for PRD flashcard adaptation.
-- Cron receives weak cards first plus recently learned cards from prior days so reviews can span Days 1-N.
